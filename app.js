...
// 레벨퀘스트 이미지
app.use('/quest-images', express.static(path.join(__dirname, 'public/src-quest')));

// 랭킹 페이지 벳지 이미지
app.use('/badge-img', express.static(path.join(__dirname, 'public/src-badge')));

// 프로필 아이콘 이미지
app.use('/profile', express.static(path.join(__dirname, 'public/src-profile')));

// 티어 이미지
app.use('/tier-img', express.static(path.join(__dirname, 'public/src-tier')));
